...
class TpModelWorker:
    ...
    def forward_batch_generation(
        ...
        if self.model_runner.server_args.compress_algorithm is not None:
            ...
            if forward_batch.compress_algorithm == "RKV":
                forward_batch.compress_cluster = KVCluster(
                    window_size=forward_batch.compress_max_window, 
                    max_capacity_prompts=forward_batch.compress_max_prompt,
                    attn_pooling="max",
                    pooling="maxpool",
                    mix_alpha=0.03,
                    retain_ratio=0.2,
